...
## Sitzung IX Datenvisualisierung - Begleitendes Skript 
## 16.05.2024
...
# - Grafische Elemente
#   Legen fest, welche Form der 
#   Visualisierung verwendet wird geoms oder stat_functions 
#   Skalen, Beschriftungen und Legenden
# - Aesthetische Elemente 
#   (aes()) Legt grafische Parameter fest (z. B. Farbe, Transparenz, 
#   Schriftgroesse etc.) (bis auf Kennzeichnung der Achsen optional)
...
# binwidth = 10 bestimmt die Groe?e der Gruppen, in denen die 
...
# Meistens interessiert man sich nicht nur f?r ein einziges, 
# sondern gleichzeitig f?r zwei oder mehrere Merkmale und 
...
# und erstellt die gleiche Grafik f?r die Teildatensaetze
...
# minimal, zuf?llig variiert, damit sich die Punkte besser 
# voneinander abheben 
...
# Als Argument f?r die Farben k?nnen die Standardbezeichnung von 
...
# size = x bestimmt die Gr??e der Datenpunkte (x in mm)
